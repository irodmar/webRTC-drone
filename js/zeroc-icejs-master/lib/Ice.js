...
(function(global, r)
{
    ...
    var Ice = global.Ice || {};
    Slice.defineDictionary(Ice, "PropertyDict", "PropertyDictHelper", "Ice.StringHelper", "Ice.StringHelper", false, false);
...
(function(global, r)
{
     ...
     * 
     **/
    IceWS.ConnectionInfo = Slice.defineLocalObject(
        function(incoming, adapterName, connectionId, localAddress, localPort, remoteAddress, remotePort)
        {
            Ice.IPConnectionInfo.call(this, incoming, adapterName, connectionId, localAddress, localPort, remoteAddress, remotePort);
        },
...
(function(global, r)
{
    ...
    Object.defineProperty(IceWS, 'WSEndpointType', {
        value: 4
    });

    Object.defineProperty(IceWS, 'WSSEndpointType', {
        value: 5
    });
     ...
     * 
     **/
    IceWS.EndpointInfo = Slice.defineLocalObject(
        function(timeout, compress, host, port, resource)
        {
            Ice.IPEndpointInfo.call(this, timeout, compress, host, port);
